...
export default function LoginPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      // 👇 yahan future mein real login API lagegi
      ...
      // navigate("/dashboard"); // future redirect
    } catch (err) {
      console.log(err);
      ...
      <div className="max-w-xl w-full grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
        ...
        <div className="hidden md:flex flex-col gap-4 p-6 rounded-2xl shadow-lg bg-white/60 backdrop-blur-md animate-fadeIn">
          ...
          <p className="text-sm text-slate-600">
            Login to continue to your dashboard. Secure access with Tailwind +
            React.
          </p>
        ...
        <div className="w-full bg-white rounded-2xl shadow-xl p-6 md:p-8 transform transition duration-300 hover:scale-[1.01]">
          ...
          <div className="space-y-4">
                ...
                {showPassword ? (
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d="M13.875 18.825A10.05 10.05 0 0112 19c-5.523 0-10-4.477-10-10a9.97 9.97 0 012.175-6.125M15 12a3 3 0 11-6 0 3 3 0 016 0z"
                    />
                  </svg>
                ) : (
                  <svg
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-.575 1.763-1.666 3.25-2.95 4.33M15 12a3 3 0 11-6 0 3 3 0 016 0z"
                    />
                  </svg>
                )}
              </Button>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                type="button"
                className="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-200 px-3 py-2 hover:bg-slate-50"
              >
                {/* Google SVG */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                >
                  <path
                    fill="#EA4335"
                    d="M24 12.5v8.5h13.9C36.4 27.9 31.6 31 24 31 16.2 31 9.8 25.2 9.8 17.9S16.2 4.9 24 4.9c3.8 0 6.9 1.4 9 3.3l6.4-6.4C36.3 1.2 30.6 0 24 0 10.7 0 0 10.7 0 24s10.7 24 24 24 24-10.7 24-24c0-1.6-.1-3.1-.4-4.6H24z"
                  />
                </svg>
